...
export const metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: `${SITE}/guides/how-to-spot-ai-images` },
  openGraph: { title: TITLE, description: DESC, url: `${SITE}/guides/how-to-spot-ai-images` },
};
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify(articleJsonLd({ title: TITLE, description: DESC, path: "/guides/how-to-spot-ai-images" })),
      }} />
