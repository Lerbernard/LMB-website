...
export const metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: `${SITE}/guides/check-part-of-an-image-for-ai` },
  openGraph: { title: TITLE, description: DESC, url: `${SITE}/guides/check-part-of-an-image-for-ai` },
};
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify(articleJsonLd({ title: TITLE, description: DESC, path: "/guides/check-part-of-an-image-for-ai" })),
      }} />
