...
export const metadata = {
  title: TITLE,
  description: DESC,
  alternates: { canonical: `${SITE}/ai-image-detector/guides/how-ai-image-detectors-work` },
  openGraph: { title: TITLE, description: DESC, url: `${SITE}/ai-image-detector/guides/how-ai-image-detectors-work` },
};
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify(articleJsonLd({ title: TITLE, description: DESC, path: "/ai-image-detector/guides/how-ai-image-detectors-work" })),
      }} />
