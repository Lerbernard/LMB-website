    ...
    <>
      <nav className="nav">
        <div className="wrap nav-in">
          ...
          <a className="brand product" href="/overlai"><DetectorLogo size={28} /> AI Image Detection</a>
      ...
      <header className="hero" id="top">
        ...
        <div className="wrap">
          <span className="eyebrow"><Logo size={18} /> Seeing isn&apos;t believing</span>
          <h1 className="display">Is this image <span className="g">real</span>,<br />or made by AI?</h1>
      ...
      <main className="wrap">
        <section className="detector" id="detector">
          {!preview && (
            ...
            >
              <div className="dz-badge"><Logo size={96} /></div>
